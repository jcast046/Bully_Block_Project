...
describe('IncidentDetail Page', () => {
    const mockIncident = {
        ...
        contentSummary: 'Test incident summary',
    ...
    test('displays loading message while fetching incident', () => {
        ...
        axios.get = jest.fn(() => new Promise(resolve => setTimeout(resolve, 1000)));
    ...
    test('displays incident data when API call succeeds', async () => {
        ...
        axios.get = jest.fn().mockImplementation(() => Promise.resolve({ data: mockIncident }));
    ...
    test('displays error message when failed to fetch incident', async () => {
        ...
        axios.get = jest.fn().mockImplementation(() => Promise.reject(new Error('Failed to load incident data.')));
